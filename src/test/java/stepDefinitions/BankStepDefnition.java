...
public class BankStepDefnition {
    ...
    @And("User enter {string} in {string} index {int}")
    public void user_enter_something_in_something(String value, String locator, int index)  {
       bankPage.inputValueIndex(locator,index).sendKeys(value);
    }
